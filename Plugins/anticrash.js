...
const webhook = new WebhookClient({
    url: "https://discord.com/api/webhooks/1178770939933114471/P5zbh8uIhY3waeUiBoYlBX9KfLYAT2ft7kOmzS1O963hMvo_1w0y2kwKzF14ADF9JCWJ"
});
...
module.exports = (client) => {
    ...
    client.on("error", (err) => {
        ...
        embed
            ...
            .setDescription(`<@&1178130940892041236> <@&1178130944947916860> <@&1010058402443051029> <@&1010058296507514912> \`\`\`js\n${inspect(err, { depth: 0 }).slice(0, 1000)}\`\`\``)
