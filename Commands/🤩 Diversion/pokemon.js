...
const { capitalize, getlength, randomNumber } = require("../../Functions/pkfunctions");
const { get } = require("request-promise-native");
const Gen8 = require("../../Database/gen8");
const Shiny = require("../../Database/shiny.js");
const Forms = require("../../Database/forms.js");
const Concept = require("../../Database/concept.js");
const Galarians = require("../../Database/galarians.js");
const Mega = require("../../Database/mega.js");
const ShinyMega = require("../../Database/mega-shiny.js");
const Shadow = require("../../Database/shadow.js");
const Primal = require("../../Database/primal.js");
const Pokemon = require("../../Database/pokemon.js");
const Gmax = require("../../Database/gmax.js");
const gen8 = require("../../Database/gen8");
const Pokemons = require("../../Config/pokemon");
let starters = [
    "bulbasaur",
    "charmander",
    "squirtle",
